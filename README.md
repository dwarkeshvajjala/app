...
# 3. Recovery worker (separate terminal, from backend/) - only needed for the
#    revision/recovery pipeline (Milestone 8); everything else works without it.
cd backend
