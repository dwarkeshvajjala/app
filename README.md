...
Dashboard UI for triaging comments (kanban/list board) is Milestone 6; wiring the matcher into an automatic revision-triggered recovery pipeline (diff engine, `recovery_logs`, orchestration) is Milestone 8 - M5 is the matching algorithm itself, by design (`20-Build-Plan.md`).
